...
if not confirm():
	...
	val=input("Enter any additional comments to include with the comments about grades: ").strip()
	if val!="":
...
exportGrades(activeAssignment, outOf100=True)
print("Grades exported")
print("Run 'post comments.py' to upload them")
