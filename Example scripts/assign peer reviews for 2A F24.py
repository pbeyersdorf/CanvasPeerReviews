...
assignCalibrationReviews(assignment=activeAssignment, ignoreSections=True)
...
assignPeerReviews(creations, numberOfReviewers=params.numberOfReviews, AssignPeerReviewsToGraderSubmissions=False, ignoreSections=True)
...
announce(subject, body, section="all")
