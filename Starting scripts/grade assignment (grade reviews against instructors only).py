...
while not acceptedCurve:
	...
	grade(activeAssignment, reviewScoreGrading="compare to instructor")	# will grade reviews compared only to instructor	
	#grade(activeAssignment, reviewScoreGrading="calibrated grading") # will grade reviews compared to ALL students	
