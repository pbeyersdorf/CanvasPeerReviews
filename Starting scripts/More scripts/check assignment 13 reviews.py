...
for s in students:
	for key,review in s.reviewsGiven.items():
		if review.assignment_id == ga.id:
			try:
				if review.scores['_5705'] != review.scores['_4049']:
				...
				pass
print("The following students gave reviews where the 'other' score did not match the 'Solution accurac' score")	
