...
for student in students:
	completed=student.numberOfReviewsGivenOnAssignment(assignment.id)
	assigned=student.numberOfReviewsAssignedOnAssignment(assignment.id)
	if completed>assigned:
		needToResync=True
if needToResync:
	print("f{Resyncing reviews now…}")
